...
module durable_tid_v0 #(
  ...
  localparam logic [1:0] S_SUBMIT   = 2'd1;
  localparam logic [1:0] S_COMMIT   = 2'd2;
  localparam logic [1:0] S_COMPLETE = 2'd3;
  ...
  function [31:0] crc32_ieee(input [127:0] data);
    reg [31:0] crc;
    integer i, j;
    begin
      crc = 32'hFFFFFFFF;
  ...
  always @(posedge clk or negedge reset_n) begin
    if (!reset_n) begin
      ...
      // Blocking temps: exactly one nonblocking update each at block end.
      logic [31:0] ctrl_n;
      logic [31:0] err_n;
      logic [63:0] req_full;
      ctrl_n   = ctrl;
